...
public class SequencePattern {
    ...
    public SequencePattern(List<Predicate<InputEvent>> steps) {
        this.steps = steps;
    }
    ...
    static {
        ...
        m.put("SCROLL_UP",  e -> e instanceof MouseWheelEvent mw && mw.rotation()<0);
        m.put("SCROLL_DOWN",e -> e instanceof MouseWheelEvent mw && mw.rotation()>0);
    ...
    public static SequencePattern literal(String raw) {
        ...
        var preds = Arrays.stream(tokens)
                ...
                .toList();
        return new SequencePattern(preds);
    }
